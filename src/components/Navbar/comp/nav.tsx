      ...
      <header className="rounded-br-4xl rounded-tr-4xl fixed pt-15 bg-[#7f00d4] opacity-90 w-auto hover:w-[250px] duration-300 ease-in-out z-10 sm:w-[80px] sm:hover:w-[250px]">
        ...
        <li>
          <div className="z-50 ml-1 p-5 flex-col items-center">
            ...
            <Link href="/movies">
              <RiMovieFill className="z-50 cursor-pointer text-white mb-10 text-2xl transition-all duration-300 hover:text-yellow-400 hover:scale-125 hover:-rotate-6" />
            </Link>
            <Link href="/favorite">
              <GiTentacleHeart className="z-50 cursor-pointer text-white mb-10 text-2xl transition-all duration-300 hover:text-pink-400 hover:scale-125 hover:rotate-12" />
            </Link>
            <Link href="/watchlater">
              <MdWatchLater className="z-50 cursor-pointer text-white mb-10 text-2xl transition-all duration-300 hover:text-yellow-400 hover:scale-125 hover:-rotate-12" />
            </Link>
            <Link href="/profile">
              <IoMdPerson className="z-50 cursor-pointer text-white mb-10 text-2xl transition-all duration-300 hover:text-yellow-400 hover:scale-125 hover:rotate-3" />
            </Link>
            <Link href="/help">
              <IoIosHelpCircleOutline className="z-50 cursor-pointer text-white mb-10 text-2xl transition-all duration-300 hover:text-yellow-400 hover:scale-125 hover:-rotate-3" />
            </Link>
          </div>
        </li>
        <li>
